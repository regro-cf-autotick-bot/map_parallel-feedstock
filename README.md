...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/map_parallel-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11497&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/map_parallel-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `map_parallel` can be installed with:

```
conda install map_parallel
```

It is possible to list all of the versions of `map_parallel` available on your platform with:
